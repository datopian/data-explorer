      ...
      "resources": [
        {
          ...
          "schema": {
            "fields": [
              {"name": "ENG.Week", "type": "string"},
              {"name": "ENG.Year", "type": "string"},
              {"name": "Publish Date", "type": "string"},
              {"name": "Peak Demand Forecast", "type": "number"},
              {"name": "Generator Availability", "type": "number"},
              {"name": "Maximum I/C Import", "type": "number"},
              {"name": "Maximum I/C Export", "type": "number"},
              {"name": "Generation Availability Margin", "type": "number"},
              {"name": "Operating Reserve provided by I/Cs", "type": "number"},
              {"name": "OPMR total", "type": "number"},
              {"name": "Constrained Plant", "type": "number"},
              {"name": "National Surplus", "type": "number"},
              {"name": "Minimum Demand Forecast", "type": "number"},
              {"name": "High Freq Response Requirement", "type": "number"},
              {"name": "Negative Reserve", "type": "number"}
            ]
          },
          "package_id": "025b9417-83a0-445b-a818-414ea49cf7c3",
